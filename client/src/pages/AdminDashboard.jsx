...
const AdminDashboard = () => {
  ...
  const noFilteredProducts = products.length > 0 && filteredProducts.length === 0;
  const hasSearchQuery = normalizedSearch !== '';
          ...
          <div className="p-3 sm:p-4 md:p-6">
            ...
            {activeTab === 'products' && (
              <div>
                ...
                {products.length > 0 && noFilteredProducts && (
                  <div className="text-center py-12">
                    <div className="w-16 h-16 mx-auto mb-4 bg-gray-100 rounded-full flex items-center justify-center">
                      <span className="text-2xl text-gray-400">⚠</span>
                    </div>
                    <h3 className="text-xl font-semibold text-gray-800 mb-2">
                      {hasSearchQuery ? 'No Products Match Your Search' : 'No Products In This Category'}
                    </h3>
                    <p className="text-gray-600">
                      {hasSearchQuery
                        ? 'Try changing your keywords or add a new product.'
